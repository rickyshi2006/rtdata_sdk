...
klines = api.get_history("601919.SH", period="1d",
...
klines = api.get_history("000001.SZ", period="1d",
...
klines = api.get_history("000001.SZ", period="1m", start="2015-06-17", end="2015-06-17")
...
for code in stocks:
    try:
        klines = api.get_history(code, period="1d",
